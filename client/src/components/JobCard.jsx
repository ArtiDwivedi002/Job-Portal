  ...
  return (
    <div className="border p-6 shadow rounded">
      <div className="flex justify-between items-center">
       <img className='h-8' src={job.companyId?.image || assets.defaultCompanyLogo} alt='Company Logo' />
      ...
      <div className="mt-4 flex gap-10 text-sm">
        <button onClick={()=>{navigate(`/apply-job/${job._id}`);scrollTo(0,0)}} className="bg-blue-600 text-white px-4 py- 2rounded">Apply Now</button>
