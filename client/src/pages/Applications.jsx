          ...
          {isEdit || (userData && userData.resume === '') ? (
            <>
              ...
              <button
                ...
                className='bg-green-100 border border-green-400 rounded-lg py-2 px-4'
              >
                Save
              </button>
            </>
                  ...
                  <tr key={index}>
                    <td className="py-3 px-4 flex items-center gap-3 border-b">
                      <img
                        ...
                        src={company?.image || assets.default_company_logo}
                    ...
                    <td className='py-2 px-4 border-b'>{jobInfo?.title || '—'}</td>
